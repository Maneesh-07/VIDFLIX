...
class _FavIconWidgetState extends State<FavIconWidget> {
  ...
  Widget build(BuildContext context) {
    return IconButton(
        onPressed: () {
          setState(() {
            if (!favoritesVideoNotify.value.contains(widget.video)) {
              addLikedVideo(context, widget.video);
              isListView.notifyListeners();
            } else {
              removeLikedVideo(
                  favoritesVideoNotify.value.indexOf(widget.video), context);
              isListView.notifyListeners();
        ...
        icon: Icon(
          favoritesVideoNotify.value.contains(widget.video)
              ? Icons.favorite
